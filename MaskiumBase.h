...
#include "MaskiumBase.generated.h"
/**
 *
 */
class UAkComponent;
...
UCLASS()
class NOVAFINAL_API AMaskiumBase : public AFighterBase
{
	GENERATED_BODY()

public:
	AMaskiumBase(const FObjectInitializer& ObjectInitializer);
...
protected:
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<UMaterialInterface*> HelmColour;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<UMaterialInterface*> CapeColour;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<UMaterialInterface*> BodyColour;
public:
	UPROPERTY(ReplicatedUsing = OnRep_SetCharColour)
		UMaterialInterface* SelectedHelmColour;
	UPROPERTY(ReplicatedUsing = OnRep_SetCharColour)
		UMaterialInterface* SelectedCapeColour;
	UPROPERTY(ReplicatedUsing = OnRep_SetCharColour)
		UMaterialInterface* SelectedBodyColour;
	UFUNCTION(Server, WithValidation, Reliable)
...
public:
	...
	UPROPERTY(EditAnywhere)
		float SpecChargeTime = 0.15f;
	FTimerHandle TimerHandle_ShootProj;

	UPROPERTY(Replicated, EditAnywhere)
		UParticleSystem* BeamSystem = nullptr;
#pragma endregion
#pragma region Wise
public:
	//==========Paul's Wwise Stuff================
...
#pragma endregion
	...
	UPROPERTY(EditAnywhere)
		float LightGroundKBTime = .25f;
	UPROPERTY(EditAnywhere)
		float LightAirKBTime = .30f;
	UPROPERTY(EditAnywhere)
	...
	UPROPERTY(EditAnywhere)
		float MedLauncherKBTime = 1.25f;
	UPROPERTY(EditAnywhere)
		float MedGroundKBTime = .75f;
	UPROPERTY(EditAnywhere)
